 ...
 * @Description:
 * 微信小程序 贝因美贝家商城 每日签到
 * 捉h5.youzan.com域名任意包下的Cookie中的KDTWEAPPSESSIONID=XXXXXXXXXX,填写到mbym_cookie中,多帐号换行
 * 
...
const $ = new Env("贝因美贝家商城");
const env_name = "bym_cookie";
...
function checkin(user) {
    return new Promise((resolve) => {
        ...
        const signinRequest = {
            url: "https://h5.youzan.com/wscump/checkin/checkinV2.json?checkinId=8249",
            headers: header,
        };
