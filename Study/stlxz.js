/*
 * @Author: Sliverkiss
 * @Date: 2023-05-18 08:50:39
 * @FilePath: https://github.com/Sliverkiss/helloworld/Study/stlxz.js
 * @Description:
 * STLXZ 3D打印模型每日签到 积分可以兑换模型
 * 捉www.stlxz.com域名包下的Cookie,填写到stl_cookie中，多账号用#号连接
 * 
...
function signin(user) {
    return new Promise((resolve) => {
        ...
        const signinRequest = {
            url: "https://www.stlxz.com/wp-admin/admin-ajax.php?action=user_checkin",
            headers: header,
        };
