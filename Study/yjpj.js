/*
 * @Author: Sliverkiss
 * @Date: 2023-05-20 16:42:31
 * @FilePath: https://github.com/Sliverkiss/helloworld/Study/yjpj.js
 * @Description:
 * 微信小程序 燕京啤酒小程序官方旗舰店 每日签到 瓶盖可以兑换实物
 * 捉h5.youzan.com域名任意包下的Cookie中的KDTWEAPPSESSIONID=XXXXXXXXXX,填写到yjpj_cookie中,多帐号换行
 * 
 * 只用过loon，理论上支持qx、surge，请自行尝试
 * 
 * [Script]
 * cron "0 30 1 * * *" script-path=https://raw.githubsercontent.com/Sliverkiss/helloworld/main/Study/yjpj.js, timeout=300, tag=燕京啤酒
 * 
 */

const $ = new Env("燕京啤酒");
const env_name = "yjpj_cookie";
...
function checkin(user) {
    return new Promise((resolve) => {
        ...
        const signinRequest = {
            url: "https://h5.youzan.com/wscump/checkin/checkinV2.json?checkinId=2299510",
            headers: header,
        };
